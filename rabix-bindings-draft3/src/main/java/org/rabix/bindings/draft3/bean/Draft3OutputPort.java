...
public class Draft3OutputPort extends ApplicationPort {
  ...
  public Draft3OutputPort(@JsonProperty("id") String id, @JsonProperty("format") Object format, @JsonProperty("default") Object defaultValue,
      ...
      @JsonProperty("scatter") Boolean scatter, @JsonProperty("source") Object source, @JsonProperty("secondaryFiles") Object secondaryFiles, @JsonProperty("linkMerge") String linkMerge, @JsonProperty("pickValue") String pickValue, @JsonProperty("description") String description) {
